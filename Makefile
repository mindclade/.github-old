...
.PHONY: validate lint contracts evidence-contracts release-spec pins policy-bundle repository-home third-party-notices validate-production-contract

validate: lint contracts evidence-contracts release-spec pins policy-bundle repository-home third-party-notices validate-production-contract
...
policy-bundle:
	$(PYTHON) tools/policy_bundle.py verify
